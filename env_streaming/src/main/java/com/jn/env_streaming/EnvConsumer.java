...
public class EnvConsumer {
    ...
    SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd-HHmmss");
        private final String GROUP_ID = "env_group_test_streaming";
    ...
    private void init() throws SQLException, ClassNotFoundException {
        SparkConf sparkConf = new SparkConf()
                ...
                .setAppName("env_streaming_spark_test")
                .setMaster("local[*]");
    ...
    private void createSchemas(JavaSparkContext spark, HiveContext hive) {
        ...
        schemaMap.put("env_jnxzbmjk", bdcqhyDF);
        ...
        schemaMap.put("env_jcdwjcxxjk", hydjDF);
        ...
        try {
            ...
            Arrays.stream(offsetRanges).forEach(x -> {
                try {
                    ...
                    sb.append("replace into t_offset_test ")
